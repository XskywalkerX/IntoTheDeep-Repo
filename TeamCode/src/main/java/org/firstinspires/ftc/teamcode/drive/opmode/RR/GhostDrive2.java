...
public class GhostDrive2 extends MecanumDrive {

    public static PIDCoefficients TRANSLATIONAL_PID = new PIDCoefficients(10, 0, 0.5);
    public static PIDCoefficients HEADING_PID = new PIDCoefficients(8, 0, 0.6);

    public static double LATERAL_MULTIPLIER = 1.663636363636364;
    ...
    private DcMotorEx ghostLF, ghostLR, ghostRR, ghostRF;
    ...
    public GhostDrive2(HardwareMap hardwareMap) {
        ...
        /*ghostLF = hardwareMap.get(DcMotorEx.class, "frontLeft");
        ghostLR = hardwareMap.get(DcMotorEx.class, "backLeft");
        ghostRR = hardwareMap.get(DcMotorEx.class, "backRight");
        ghostRF = hardwareMap.get(DcMotorEx.class, "frontRight");*/

        motors = Arrays.asList(ghostLF, ghostLR, ghostRR, ghostRF);
        ...
        ghostLF.setDirection(DcMotorSimple.Direction.REVERSE);
        ghostLR.setDirection(DcMotorSimple.Direction.REVERSE);
        ghostRF.setDirection(DcMotorSimple.Direction.FORWARD);
        ghostRR.setDirection(DcMotorSimple.Direction.FORWARD);
    ...
    public double getLFPower(){
        return ghostLF.getPower();
    }

    public double getLRPower(){
        return ghostLR.getPower();
    }

    public double getRRPower(){
        return ghostRR.getPower();
    }

    public double getRFPower(){
        return ghostRF.getPower();
    }
