...
import org.firstinspires.ftc.teamcode.drive.opmode.RR.DriveConstants;
...
public class TrajectorySequenceRunner {
    ...
    volatile public static List<Vector2d> Obstacles = new ArrayList<>();

    volatile public static double RANGE = 5;
    ...
    public void followTrajectorySequenceAsyncBTS(TrajectorySequence trajectorySequence) {
        currentTrajectorySequence = trajectorySequence;
        currentSegmentStartTime = clock.seconds();
        currentSegmentIndex = 0;
        lastSegmentIndex = -1;
